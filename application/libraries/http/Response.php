...
class Response
{
     ...
     * @return array
     */
    protected function respondFormat($status = null, $message = '', $data = null, $extra_data = null)
    {
        $formate = [
            "code" => $status,
            "message" => $message,
        ...
        if (is_array($extra_data)) {
            $formate = array_merge($formate, $extra_data);
        }
        return $formate;
    }
     ...
     * 
     */
    public function create($statusCode = 200, $message = "", $data = null, $extra_data = null)
    {
        return $this->json($this->respondFormat($statusCode, $message, $data, $extra_data));
    }
...
/* Location: ./application/libraries/http/Response.php */
